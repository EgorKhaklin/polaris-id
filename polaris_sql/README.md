...
Appendix A, **22 stored procedures and functions** (v9.234: UC-1, UC-4, UC-5,
...
4. Loads sample data including two closed `AnchorBatch` rows
   (R10-2) (`04_data.sql`)
5. Defines 22 stored procedures and functions (UC-1 / UC-4 / UC-5 / UC-6 / UC-7 /
