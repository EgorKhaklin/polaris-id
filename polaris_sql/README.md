...
is in BCNF (proven in §6.5 of the report), implements **32 tables** (v9.322; a migrated deployment holds 39, with the
...
| `01_schema.sql` | DDL: 32 tables (incl. ExchangeReceiptLog, RelyingParty, IssuerDiscretionPolicy, EnrollmentStatusEvent, RecoveryRequest, TokenSignature, AnchorBatch, AgencyTrustAttestation, TokenStateEpoch, TokenStateEpochLeaf, DuressEvent, LifecycleArchiveCheckpoint, AppUser, AuthAuditLog, RetentionPolicy) |
