...
is in BCNF (proven in §6.5 of the report), implements **31 tables** (v9.288; a migrated deployment holds 38, with the
...
1. Creates all 31 tables (`01_schema.sql`)
...
| `01_schema.sql` | DDL: 31 tables (incl. RelyingParty, IssuerDiscretionPolicy, EnrollmentStatusEvent, RecoveryRequest, TokenSignature, AnchorBatch, AgencyTrustAttestation, TokenStateEpoch, TokenStateEpochLeaf, DuressEvent, LifecycleArchiveCheckpoint, AppUser, AuthAuditLog, RetentionPolicy) |
