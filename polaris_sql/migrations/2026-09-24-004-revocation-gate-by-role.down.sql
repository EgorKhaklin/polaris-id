-- Reverts 2026-09-24-004: the three procedures as SECURITY INVOKER, the trigger admitting any
-- session that set polaris.revoke_check_done, and the default bound read from the session.
...
DROP FUNCTION IF EXISTS polaris_database_setting(TEXT);
