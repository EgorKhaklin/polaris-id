-- 2026-09-25-007 down: the fourteen objects back to CURRENT_DATE, then polaris_utc_date() dropped.
-- Bodies copied from the canonical files as they stood before the up migration.
...
DROP FUNCTION polaris_utc_date();
