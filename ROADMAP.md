...
release; CVE gates on dependencies and images; a coverage floor; 188 invariant
checks (v9.336) each with a detection test; eighteen operator runbooks and ledgers; and the bound on
