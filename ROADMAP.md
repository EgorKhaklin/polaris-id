...
release; CVE gates on dependencies and images; a coverage floor; 186 invariant
checks (v9.334) each with a detection test; eighteen operator runbooks and ledgers; and the bound on
