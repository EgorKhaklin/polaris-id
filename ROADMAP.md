...
release; CVE gates on dependencies and images; a coverage floor; 187 invariant
checks (v9.335) each with a detection test; eighteen operator runbooks and ledgers; and the bound on
