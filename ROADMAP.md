...
release; CVE gates on dependencies and images; a coverage floor; 156 invariant
...
suite now ship (P3.4/P3.5); multi-instance interop remains); the offline verification protocol (P3.6: a signed status bundle
