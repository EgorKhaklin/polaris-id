...
release; CVE gates on dependencies and images; a coverage floor; 151 invariant
checks (v9.284) each with a detection test; eighteen operator runbooks and ledgers; and the bound on
