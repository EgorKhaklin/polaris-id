...
release; CVE gates on dependencies and images; a coverage floor; 144 invariant
checks (v9.276) each with a detection test; eighteen operator runbooks and ledgers; and the bound on
