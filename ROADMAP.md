...
release; CVE gates on dependencies and images; a coverage floor; 149 invariant
checks (v9.281) each with a detection test; eighteen operator runbooks and ledgers; and the bound on
