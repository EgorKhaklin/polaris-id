...
**Have, working, CI-proven:** a 36-table constraint-enforced schema (43 tables
in a migrated deployment) with append-only audit; a 119-route application with
...
release; CVE gates on dependencies and images; a coverage floor; 190 invariant
checks (v9.341) each with a detection test; eighteen operator runbooks and ledgers; the protocol layer
