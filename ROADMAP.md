...
**Have, working, CI-proven:** a 33-table constraint-enforced schema (40 tables
in a migrated deployment) with append-only audit; a 111-route application with
...
release; CVE gates on dependencies and images; a coverage floor; 179 invariant
