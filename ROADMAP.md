...
release; CVE gates on dependencies and images; a coverage floor; 185 invariant
checks (v9.333) each with a detection test; eighteen operator runbooks and ledgers; and the bound on
