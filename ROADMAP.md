...
**Have, working, CI-proven:** a 34-table constraint-enforced schema (41 tables
in a migrated deployment) with append-only audit; a 113-route application with
...
release; CVE gates on dependencies and images; a coverage floor; 181 invariant
