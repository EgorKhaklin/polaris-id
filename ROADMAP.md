...
release; CVE gates on dependencies and images; a coverage floor; 191 invariant
checks (v9.345) each with a detection test; eighteen operator runbooks and ledgers; the protocol layer
