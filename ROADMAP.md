...
release; CVE gates on dependencies and images; a coverage floor; 192 invariant
checks (v9.344) each with a detection test; eighteen operator runbooks and ledgers; the protocol layer
