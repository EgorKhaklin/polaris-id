...
release; CVE gates on dependencies and images; a coverage floor; 155 invariant
...
verification contract (P3.4), a Python verify SDK and the public conformance
suite (P3.5a) now ship; a TypeScript SDK (P3.5b) and multi-instance interop
remain); the offline verification protocol (P3.6: a signed status bundle
verifiable with no connectivity); status and revocation
