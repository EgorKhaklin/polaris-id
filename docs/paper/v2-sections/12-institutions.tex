...
\sImpl. Anchor verification, once available only in the detached verifier, is in both SDKs since
\code{v9.346}, so an implementation that imports no Polaris code can decide long-term validity.
