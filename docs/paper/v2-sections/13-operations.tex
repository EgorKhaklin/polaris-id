...
\begin{xltabular}{\textwidth}{>{\RaggedRight\arraybackslash}X >{\RaggedRight\arraybackslash}p{1.25in} >{\RaggedRight\arraybackslash}p{0.95in} >{\RaggedRight\arraybackslash}p{1.1in}}
