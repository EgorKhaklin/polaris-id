...
trigger stops doing so. The one instance that is not fully enforced at the schema is named rather
than glossed: \entity{RecoveryRequest} rests on a partial unique index and procedure discipline, and
a raw update from a database session is not refused. \sImpl
