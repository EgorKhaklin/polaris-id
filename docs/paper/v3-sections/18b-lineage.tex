...
\begin{itemize}
  ...
  \item the \emph{assurance method}: mutating the assurance layer itself (the checks, triggers,
    procedures, verifiers and witnesses) to find green checks that prove the wrong proposition, the
    described in Section~\ref{sec:senses}, with its record in Appendix~\ref{app:corrections};
