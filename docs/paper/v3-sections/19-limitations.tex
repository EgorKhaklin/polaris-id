...
\begin{itemize}
  \item No path in the product records the recovery ceremony's three out-of-band channels (the
    ...
    decision page shows them as pending, and since 1.0.0-rc.54 only the schema owner can set them,
...
\midrule
\endhead
The schema refuses what the application must not do (C1, C2, C3) & Constraints, triggers and grants; mutation drills; since rc.45 the suites also run as the application role & Attack the database as the application role with the schema in hand \\
