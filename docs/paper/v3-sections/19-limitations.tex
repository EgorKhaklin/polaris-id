...
at \code{1.0.0-rc.1} Polaris is not production-ready for real identity data. Every engineering gap
...
\begin{itemize}
  ...
  \item Two identifier columns remain 32-bit, with about twenty-nine years of headroom at the stated
    enrolment rate; the interim credential during a recovery cool-down is not built; a sunset verdict
...
followed the code at \code{1.0.0-rc.1} and says so in the note.
