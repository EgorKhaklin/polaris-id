...
\code{DORMANT} when a successor takes over. Version 1's figure left out the revocation of a reserve
token, which the trigger has always allowed.}{fig:lifecycle}
