...
system (\evidencerecord). At
\code{1.0.0-rc.7} the default signing algorithm is ML-DSA-65 (the lattice-based signature standard FIPS 204), ML-DSA-87 is accepted beside
it, the zero-knowledge proof system (which proves a statement without revealing the data behind it) is hash-based with no trusted setup, and the public TLS edge and
...
Two of them the project learned most expensively: the green test, which Section~\ref{sec:senses} is
about, and the last, which the last ring, Section~\ref{sec:outside}, carries.
