...
\subsection{Why post-quantum from the first day, and what the phrase is allowed to mean}
...
system. That argument is unchanged and is summarised in Appendix~\ref{app:from-v1}. At
\code{1.0.0-rc.1} the default signing algorithm is ML-DSA-65 (FIPS 204), ML-DSA-87 is accepted beside
...
What the repository claims about that has narrowed since Version 2, and the narrowing is one of this
version's subjects. \emph{Post-quantum} is accurate about the algorithms. It is not a claim the
