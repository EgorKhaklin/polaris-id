...
rule, Section~\ref{sec:research}, that counts only what outsiders do as progress) the repository's lab asked the question directly: given complete transcripts from two presentations,
...
default} still means the issuer's zero-knowledge-mode records. \sImplMark{} for the derivations and the
