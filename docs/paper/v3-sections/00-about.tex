...
\code{1.0.0-rc.1} (commit \code{7019bcf}, 16 September 2026), re-measured whole rather than patched,
and it is written for a reader who has never opened the repository.
...
figure, was measured at \code{1.0.0-rc.1} by the methods in Appendix~\ref{app:counts}. Where a number
...
\begin{description}
  \item[\sImpl] A path that runs at \code{1.0.0-rc.1}, exercised by a test or a drill in continuous
...
Numbers were measured on the tree at \code{1.0.0-rc.1} by the methods in
