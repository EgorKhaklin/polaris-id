...
a configuration one. Identity never becomes a login product by accident. Since \code{v9.425} a
...
person identifier and, since \code{v9.353}, not the same value at every relying party. The token
...
that the authorization code was signed but readable; it is now encrypted. And the conformance
...
Version 2 could tell a reader how to run Polaris from a clone. Version 3 can tell a reader how to
reach one accepted presentation from software nobody here wrote, on a clean machine, in about ten
