...
\motif{Being verified is not being followed.}
...
\sImplMark{} for the protocol and the reference script; \sFut{} for native clients.
...
outside the repository has yet reported walking it. \sImplMark{} for the path; \sExt{} for a walker
