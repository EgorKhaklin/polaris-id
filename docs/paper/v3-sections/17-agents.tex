...
Post-quantum trust & ML-DSA under an audited migration path, hash-based proofs, a hybrid edge; classical remainders named; what a break would cost written down & \sImplMark \\
