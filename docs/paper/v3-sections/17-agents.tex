...
\begin{itemize}
  \item \textbf{Uniqueness at issuance.} C3, one active token per person, is a partial unique index
    in the database, and since \code{v9.374} a model checked on every push. What it establishes is
    ...
    enrolment desk, by an operator's judgement recorded as evidence (Section~\ref{sec:privacy}). An
    earlier version of this paper called C3 ``the root of Sybil resistance''; the mechanism does
    not support the phrase, and it is withdrawn. \sImpl
