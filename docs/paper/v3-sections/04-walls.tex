...
surfaces a check quantifies over, and the moves of code between modules. Section~\ref{sec:senses} describes that layer, and Appendix~\ref{app:corrections} carries the record.
\sImpl
