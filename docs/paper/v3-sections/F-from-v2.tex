...
\begin{xltabular}{\textwidth}{>{\RaggedRight\arraybackslash}p{2.0in} >{\RaggedRight\arraybackslash}X >{\RaggedRight\arraybackslash}p{1.6in}}
...
The version is v9.355, a count of ships & The version is \code{1.0.0-rc.1}, moved only by an externally observable change & The operating contract's versioning rule \\
...
documents that disagree with the code at \code{1.0.0-rc.1} were not corrected for the paper; they
