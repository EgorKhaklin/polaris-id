...
**Status (v1.0.0-rc.62): not production-ready for real identity data.** Every
...
**The operator a rule names is the operator the application names** (stated at 1.0.0-rc.62).
