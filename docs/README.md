...
| [DESIGN-INTENT-REVIEW.md](DESIGN-INTENT-REVIEW.md) | An outside reviewer's five observations, 2026-09-17, each classified as intentional or defective with the measurement behind it: the OID4VP key search, issuer_authentic against usable, what the source-text checks actually detect, the rc.1 artifact against this tree, and what 282 green checks do and do not establish. |
