...
# 12 * (8 full + 22 partial) = 360 round constants, applied in order.
ALL_ROUND_CONSTANTS = [
...
assert len(ALL_ROUND_CONSTANTS) == WIDTH * (2 * HALF_N_FULL_ROUNDS + N_PARTIAL_ROUNDS)

# Plonky2's own published permutation test vectors (input12 -> output12).
# Source: plonky2-0.2.2 src/hash/poseidon_goldilocks.rs #[test] test_vectors.
# neg_one == P - 1. These anchor our permutation to the reference,
# independent of the Polaris Rust binary.
_NEG1 = P - 1
