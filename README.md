...
| [`polaris_checks/`](polaris_checks/) | The invariant layer. 165 checks (v9.304), each with a tested failure mode. `python3 -m polaris_checks.run` gates CI. |
