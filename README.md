...
| [`polaris_checks/`](polaris_checks/) | The invariant layer. 319 checks (v1.0.0-rc.9), each with a tested failure mode. `python3 -m polaris_checks.run` gates CI. |
