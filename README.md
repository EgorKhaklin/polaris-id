...
| [`polaris_checks/`](polaris_checks/) | The invariant layer. 232 checks (v9.408), each with a tested failure mode. `python3 -m polaris_checks.run` gates CI. |
...
| Invariant checks | 232 | C1-C10 plus production posture, each check paired with a detection test |
